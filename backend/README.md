...
## Project Structure
    ...
    ├── testapiautodatamod_120880  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_120880`
...
2. Clone this repo and `cd testapiautodatamod_120880`
